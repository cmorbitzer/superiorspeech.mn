  ...
  <header className="pt-6">
    <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6">
      ...
      <div className="flex items-center justify-end md:flex-1 lg:w-0">
        ...
        <AnchorLink
          to="/#contact"
          className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-denim-600 hover:bg-denim-700"
        >
          Contact
        </AnchorLink>
      </div>
